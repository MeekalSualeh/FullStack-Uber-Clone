const AnimatedVehicle = ({
  ...
  return (
    <div className={`w-screen flex justify-center relative ${mtClass}`}>
        <div className="w-44 h-16 flex bg-green-200 justify-center rounded-4xl opacity-80">
            <div className="w-32 h-14 bg-blue-300 opacity-65 rounded-4xl">

            </div>
        </div>


        <div className={`absolute w-30 ${imgCover ? "h-32 -top-15" : "h-20 -top-7"}`}>
            <img src={imgSrc} 
            alt="Vehicle Image" 
